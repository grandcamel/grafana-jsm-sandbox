...
from grafana_jsm_sandbox.project import project_from_shell
...
PROJECT = project_from_shell()
"""The project the demo was started for: the shell's `JIRA_PROJECT`, else the one in `.env`
that the container read, else OPS (ADR 0006)."""
